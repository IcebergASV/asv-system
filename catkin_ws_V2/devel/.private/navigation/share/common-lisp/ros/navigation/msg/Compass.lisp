...
(cl:defmethod cl:initialize-instance :after ((m <Compass>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Compass)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navigation-msg:<Compass> is deprecated: use navigation-msg:Compass instead.")))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <Compass>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navigation-msg:heading-val is deprecated.  Use navigation-msg:heading instead.")
  (heading m))
